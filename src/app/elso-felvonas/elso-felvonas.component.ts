...
@Component({
  selector: 'app-elso-felvonas',
  templateUrl: './elso-felvonas.component.html',
  styleUrls: ['./elso-felvonas.component.css']
})
export class ElsoFelvonasComponent implements OnInit {
  Math: Math=Math;
  isShow = false;
  isShow2 = false;
  isShow3 = false;
